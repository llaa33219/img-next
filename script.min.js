    ...
    if (option.value === 'custom') {
      ...
      if (fileInput.files.length === 1) {
        ...
        if (!customNameInput.value) {
          ...
          // 유효한 문자만 추출 (영문, 숫자, 하이픈)
          const validName = baseName.replace(/[^a-zA-Z0-9-]/g, '');
          customNameInput.value = validName;
        }
      }
    } else {
...
customNameInput.addEventListener('input', () => {
  // 영문, 숫자, 하이픈만 허용
  customNameInput.value = customNameInput.value.replace(/[^a-zA-Z0-9-]/g, '');
});
